...
public class ToDoGUI {
    ...
    private static void createAndShowGUI() {
        taskList = ToDoApplication.loadTasks();
    ...
    private static JPanel createTaskItem(Task task) {
        ...
        prioRed.addActionListener(e -> { task.setPriority("Red"); ToDoApplication.saveTasks(taskList); refreshTasks(); });
        prioYellow.addActionListener(e -> { task.setPriority("Yellow"); ToDoApplication.saveTasks(taskList); refreshTasks(); });
        prioGreen.addActionListener(e -> { task.setPriority("Green"); ToDoApplication.saveTasks(taskList); refreshTasks(); });
        prioNone.addActionListener(e -> { task.setPriority("None"); ToDoApplication.saveTasks(taskList); refreshTasks(); });
